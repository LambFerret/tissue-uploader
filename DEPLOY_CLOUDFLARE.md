...
Cloudflare용 코드·D1 마이그레이션·로컬 테스트가 준비되어 있습니다. **운영 배포는 아직 하지 않았습니다.** 2026-09-09 계정 점검에서 R2 API가 `Please enable R2 through the Cloudflare Dashboard (10042)`를 반환했습니다. 기존 로컬 사진과 다른 앱 데이터베이스는 변경하지 않았습니다.
